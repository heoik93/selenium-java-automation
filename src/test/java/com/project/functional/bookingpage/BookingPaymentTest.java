...
import com.project.functional.mypage.MyinfoTest;
...
public class BookingPaymentTest extends BaseTest {private List<Map<String, Object>> chosenProducts;
    ...
    @Test(testName = "Booking Payment Page NewAddress SearchButton Test")
    ...
    //결제버튼테스트
    @Test(testName = "Booking Payment Page PaymentButton Test")
